...
{
    private Organization(OrganizationId id, string name, string? website, DateTimeOffset createdAt)
        : base(id)
    {
        Name = name;
        Website = website;
    ...
    public static Result<Organization> Create(string name, string? website, DateTimeOffset createdAt)
    {
