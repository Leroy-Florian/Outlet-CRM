...
public sealed class Product : AggregateRoot<ProductId>
{
    ...
    private Product(ProductId id, string name, string? description, DateTimeOffset createdAt)
        : base(id)
    {
        Name = name;
    ...
    public static Result<Product> Create(string name, string? description, DateTimeOffset createdAt)
    {
